...
const ContactUs = () => {
  return (
    <div className="container mx-auto flex flex-col p-10 md:flex-row items-center justify-between py-10">
      ...
      <div className="flex flex-col md:w-1/2 gap-y-10">
        ...
        <div className="flex items-center border rounded-full overflow-hidden relative">
          <input
          ...
          <button className="p-4 scale-75 absolute right-1 top-0 h-full px-4 bg-[#FADCD9] rounded-full flex items-center">
            ...
            <path d="M1 0.999999L7 7L1 13" stroke="#F79489" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </span>
          </button>
        </div>
      </div>
