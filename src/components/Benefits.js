...
const Benefits = () => {
  return (
    <div className="container mx-auto py-12">
      <h2 className="text-2xl md:text-4xl text-left text-[#564E4E] font-bold mb-6">Why Choosing Us</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {benefits.map(benefit => (
          <div key={benefit.id} className="text-left bg-white rounded-lg shadow-md hover:drop-shadow-2xl overflow-hidden transition border duration-300 hover:border-glow hover:border-pink-400">
            ...
            <div className="p-4">
              ...
              <a className='text-[#F79489]' href="#">more Info</a>
            </div>
          </div>
        ))}
      </div>
